<template>
  <div
    id="__next"
    class="bg-gray-800 leading-relaxed text-slate-400 antialiased selection:bg-teal-300 selection:text-white"
  ...
  >
    <div class="relative">
      ...
      >
        <div
          class="lg:flex lg:flex-row lg:justify-between lg:gap-4 flex-col-reverse"
        >
          <!-- Conteudo -->
          <main class="pt-24 lg:w-1/2 lg:py-24">
            ...
            >
              ...
              <div>
                ...
                <p class="mb-4">
                  Especializei-me no Front-End, onde acumulei vasto conhecimento
                  e experiência. Minha expertise centraliza-se em Javascript.
                  Possuo uma formação acadêmica sólida, com graduação em Artes e
                  mestrado em Modelagem Computacional, ambos pela Universidade
            ...
            >
              ...
              <div>
                <p class="mb-4">
                  Contato - Lorem, ipsum dolor sit amet consectetur adipisicing
                  elit. At mollitia quaerat quasi dolorem ea amet quisquam aut
                  sint eligendi impedit, culpa quod molestiae animi cupiditate,
                  labore saepe accusantium quibusdam laudantium.
                </p>
              </div>
            </section>
            <!--  Sessao Footer -->
          ...
          >
            <header class="flex flex-col justify-end items-end">
              <h1
              ...
              <p class="mt-4 max-w-xs leading-normal text-right">
              ...
              <nav class="nav hidden lg:block" aria-label="In-page jump links">
                <ul class="mt-16 w-max">
                  <li>
                    <a
                      class="group flex items-center justify-end py-3"
                      href="#Sobre"
                    >
                      <span
                      ...
                      >
                      <span
                        class="nav-indicator ml-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none"
                      ></span
                    ></a>
                  </li>
                  <li>
            ...
            <footer class="flex flex-col justify-end items-end">
              <div>Links Uteis</div>
              <ul
                class="ml-1 mt-8 flex items-center justify-end"
...
export default {
  methods: {
    handleMouseMove(event) {
      // Referência ao elemento com o gradiente
      ...
      // Aplica o gradiente radial no centro do cursor do mouse
      gradient.style.background = `radial-gradient(600px circle at ${x}px ${y}px, rgba(29, 78, 216, 0.15), transparent 80%)`;
    },
  },
};
</script>
